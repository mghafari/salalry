					...
					<div class="col-xl-9 col-xxl-12">
						<div class="row">
									...
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col">
												...
												<span class="text-success">جمع ویژه</span>
											</div>
										</div>
									</div>
							...
							<div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
								<div class="card bg-success	overflow-hidden">
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col">
												<h5 class="text-white mb-1">14000 تومان</h5>
												<span class="text-white">کل درآمد</span>
											</div>
										</div>
									</div>
											...
											<ul class="timeline">
												<li>
													...
													<a class="timeline-panel text-muted" href="#">
														...
														<h6 class="mb-0">یوتیوب ، یک وب سایت اشتراک ویدیو <strong class="text-primary">50000 تومان</strong>.</h6>
													</a>
												</li>
												<li>
													...
													<a class="timeline-panel text-muted" href="#">
														<span>20 دقیقه قبل</span>
														<h6 class="mb-0">سفارش جدید انجام شد <strong class="text-info">#XF-2356.</strong></h6>
												...
												<li>
													...
													<a class="timeline-panel text-muted" href="#">
														<span>30 دقیقه قبل</span>
														<h6 class="mb-0">جان فقط کالای خود را بخر <strong class="text-warning">250000 تومان</strong></h6>
													</a>
												</li>
												<li>
													...
													<a class="timeline-panel text-muted" href="#">
														<span>15 دقیقه قبل</span>
														<h6 class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. . </h6>
													</a>
												</li>
											</ul>
										</div>
							...
							<div class="col-xl-8 col-xxl-8 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h4 class="card-title">صف پرداختهای اخیر</h4>
									</div>
									<div class="card-body">
											...
											<table class="table table-responsive-sm mb-0">
												<thead>
													<tr>
														...
														<th><strong>وضعیت </strong></th>
														<th style="width:85px;"><strong>ویرایش</strong></th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														<td><b>5000 تومان</b></td>
														<td>دکتر جانسون</td>
														<td>آبان 1399</td>
														<td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-success mr-1"></i>موفقیت</td>
														<td>
													...
													<tr>
														...
														<td><b>20000 تومان</b></td>
														<td>دکتر جانسون</td>
														<td>آبان 1399</td>
														<td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-danger mr-1"></i>لغو شده</td>
														<td>
															<a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
															<a href="#" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
														</td>
													...
													<tr>
														...
														<td><b>3400 تومان</b></td>
														<td>دکتر جانسون</td>
														<td>آبان 1399</td>
														<td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-warning mr-1"></i>در انتظار</td>
														<td>
															<a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
															<a href="#" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
														</td>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
						<div class="card bg-primary text-white">
                            <div class="card-header pb-0 border-0">
                                <h4 class="card-title text-white">محصولات پرفروش</h4>
                            </div>
                            <div class="card-body"> 
                                    ...
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1 text-white">دکتر سلطان ها برای شما می فرستند</h5>
													<small class="d-block">آبان 1399 - 13:45 بعد ظهر</small>
												</div>
												<div class="dropdown">
													<button type="button" class="btn btn-primary light sharp" data-toggle="dropdown">
														<svg width="20px" height="20px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#000000" cx="5" cy="12" r="2"/><circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="19" cy="12" r="2"/></g></svg> 											</button>
                                        ...
                                        <li>
                                            <div class="timeline-panel">
												...
												<div class="media-body">
													<h5 class="mb-1 text-white">گزارش ایجاد شد</h5>
													<small class="d-block">آبان 1399 - 13:45 بعد ظهر</small>
												</div>
												<div class="dropdown">
                                        ...
                                        <li>
                                            <div class="timeline-panel">
												...
												<div class="media-body">
													<h5 class="mb-1 text-white">یادآوری: درمان</h5>
													<small class="d-block">آبان 1399 - 13:45 بعد ظهر</small>
												</div>
												<div class="dropdown">
                            ...
                            <div class="card-body pt-0">
								<div class="custom-tab-1">
                                    <ul class="nav nav-tabs mb-2">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#sale">فروش</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " data-toggle="tab" href="#overview">بررسی اجمالی</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
										...
										<div class="tab-pane fade " id="overview" role="tabpanel">
                                            <div class="pt-4 text-white">
                                                <h4 class="text-white">این عنوان خانه است</h4>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
						<div class="card active_users">
                            <div class="card-header bg-success border-0 pb-0">
                                <h4 class="card-title text-white">کاربران فعال</h4>
                            </div>
                            ...
                            <div class="card-body pt-0">
                                <div class="list-group-flush mt-4">
                                    <div class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 font-weight-semi-bold border-top-0" style="border-color: rgba(255, 255, 255, 0.15)">
                                        <p class="mb-0">صفحه های فعال برتر</p>
					...
					<div class="col-xl-6 col-xxl-12 col-lg-12 col-md-12">
						<div id="user-activity" class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									<h4 class="card-title">تاریخ 1398 - 1399</h4>
